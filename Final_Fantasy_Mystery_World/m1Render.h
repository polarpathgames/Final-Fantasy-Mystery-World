...
public:
	...
	void ResetViewPort();
	bool Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section = NULL, bool apply_scale = false, SDL_RendererFlip flip = SDL_FLIP_NONE, float speed = 1.0f, const SDL_Rect* clip_zone = NULL,double angle = 0, int pivot_x = INT_MAX, int pivot_y = INT_MAX) const;
