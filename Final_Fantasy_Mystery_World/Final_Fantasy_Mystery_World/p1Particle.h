...
public:
	...
	p1Particle(fPoint respawn, iPoint area_respawn = { 12, 2 }, iPoint timelife = { 15,5 }, fPoint speed = { 0,0 }, P_Direction p_direction = P_NON, SDL_Rect initial_rect = { 0,0,8,2 }, int size = 2, int num_tex_p = 4, bool active = false, Wind dir = W_NON, iPoint num_tex = { 0,0 });
